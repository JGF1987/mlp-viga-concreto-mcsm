...
\author{
  \rm \begin{tabular}{l}
  \textbf{Jordana [Sobrenome]}$^{1}$ --- jordana.funai@gmail.com\\
  \textbf{Maria Luiz [Sobrenome]}$^{1}$ --- [email]\\
  \textbf{Rayre [Sobrenome]}$^{1}$ --- [email]\\
  {\fontsize{11}{0}\selectfont
   $^{1}$Programa de Pós-Graduação em Modelagem Computacional e Sistemas,
...
Os autores agradecem à FAPEMIG (grant n OET-00243-26).
